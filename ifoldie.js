...
if ((browser=="Microsoft Internet Explorer")||(browser=="Mozilla Firefox")) //By default the min. IE ver is set to 6. Change as desired.
	{
	window.location="http://www.acadiaguild.com/flood/oldie.html"; //URL to redirect to.
	}
//-->